...
import { Mail, ArrowRight, ShieldCheck, RefreshCw, ExternalLink } from 'lucide-react';
    ...
    <div className="min-h-screen bg-warm-white flex items-center justify-center p-4 py-32">
      ...
      >
        ...
        <div className="flex flex-col space-y-4 max-w-sm mx-auto mb-12 relative z-10">
          ...
          <button className="flex items-center justify-center space-x-2 text-gray-400 hover:text-brand-dark transition-colors text-[10px] font-bold uppercase tracking-widest">
            <RefreshCw size={12} />
            <span>Resend security link</span>
          </button>
        </div>
