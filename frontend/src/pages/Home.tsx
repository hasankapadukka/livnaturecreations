...
import { ShoppingCart, ArrowRight, ShieldCheck, Zap, Award, Globe, Leaf } from 'lucide-react';
  ...
  return (
    <div className="bg-warm-white">
      ...
      >
        ...
        >
          {[
            { name: 'Pulses & Legumes', img: 'https://images.unsplash.com/photo-1585914924626-45adac9e6971?auto=format&fit=crop&w=500&q=80', count: '12 Products' },
            { name: 'Spices & Herbs', img: 'https://images.unsplash.com/photo-1599940824399-b87987cb9723?auto=format&fit=crop&w=500&q=80', count: '18 Products' },
            { name: 'Grains & Rice', img: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?auto=format&fit=crop&w=500&q=80', count: '8 Products' },
            { name: 'Specialty Foods', img: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=500&q=80', count: '5 Products' }
          ].map((cat, i) => (
            <motion.div
              key={i}
              variants={{
            ...
            >
              ...
              >
                ...
                <div className="absolute bottom-8 md:bottom-12 left-8 md:left-12 text-white">
                  <p className="text-[10px] font-bold tracking-widest uppercase opacity-60 mb-2">{cat.count}</p>
      ...
      >
        ...
        >
          {[
            { name: 'Red Dhal (Split)', price: 'LKR 450.00', weight: '1kg', img: 'https://images.unsplash.com/photo-1585914924626-45adac9e6971?auto=format&fit=crop&w=500&q=80' },
            { name: 'Ceylon Cinnamon', price: 'LKR 1,200.00', weight: '100g', img: 'https://images.unsplash.com/photo-1599940824399-b87987cb9723?auto=format&fit=crop&w=500&q=80' },
            { name: 'Black Pepper', price: 'LKR 850.00', weight: '250g', img: 'https://images.unsplash.com/photo-1615485290382-441e4d019cb5?auto=format&fit=crop&w=500&q=80' },
            { name: 'Green Gram', price: 'LKR 580.00', weight: '1kg', img: 'https://images.unsplash.com/photo-1626074353765-517a681e40be?auto=format&fit=crop&w=500&q=80' }
          ].map((prod, i) => (
            <motion.div
              key={i}
              variants={fadeInUp}
      ...
      <section className="py-20 md:py-32 px-4">
        <div className="max-w-[1000px] mx-auto text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto" onSubmit={(e) => e.preventDefault()}>
            ...
            />
            <button className="bg-brand-green text-white px-10 md:px-12 py-5 rounded-full text-xs font-bold tracking-[0.2em] uppercase hover:bg-brand-dark transition-all shadow-lg whitespace-nowrap">
              Subscribe
            </button>
          </form>
        </div>
