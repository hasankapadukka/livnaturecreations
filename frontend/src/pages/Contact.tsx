               ...
               <form className="space-y-8 md:space-y-12" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                     ...
                     <div className="space-y-3">
                        ...
                        <select className="w-full bg-warm-white border border-gray-200 rounded-full px-8 py-5 text-sm focus:outline-none focus:border-brand-green focus:ring-1 focus:ring-brand-green transition-all appearance-none shadow-sm cursor-pointer">
                  ...
                  <motion.button 
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-brand-green text-white px-16 md:px-20 py-5 md:py-6 rounded-full text-xs font-bold tracking-[0.2em] uppercase hover:bg-brand-dark transition-all shadow-2xl flex items-center justify-center space-x-3 group w-full sm:w-auto"
                  >
